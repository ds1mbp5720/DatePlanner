...
import com.lee.dateplanner.poimap.apimodule.POIApiModule
import com.lee.dateplanner.poimap.network.POIRetrofitService
import javax.inject.Inject

class POIRepository @Inject constructor(@POIApiModule.TypePOI private val poiRetrofitService: POIRetrofitService) {
